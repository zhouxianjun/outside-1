...
var ResourcesService_download_args = function(args) {
  this.id = null;
  if (args) {
    if (args.id !== undefined && args.id !== null) {
      this.id = args.id;
...
ResourcesService_download_args.prototype = {};
ResourcesService_download_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ResourcesService_download_args.prototype.write = function(output) {
  output.writeStructBegin('ResourcesService_download_args');
  if (this.id !== null && this.id !== undefined) {
    output.writeFieldBegin('id', Thrift.Type.I32, 1);
    output.writeI32(this.id);
    output.writeFieldEnd();
...
var ResourcesService_download_result = function(args) {
  this.success = null;
  this.ex = null;
  if (args instanceof PublicStruct_ttypes.InvalidOperation) {
    this.ex = args;
...
ResourcesService_download_result.prototype = {};
ResourcesService_download_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
ResourcesService_download_result.prototype.write = function(output) {
  output.writeStructBegin('ResourcesService_download_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.BOOL, 0);
    output.writeBool(this.success);
    output.writeFieldEnd();
...
ResourcesServiceClient.prototype.download = function(id, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
ResourcesServiceClient.prototype.send_download = function(id) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('download', Thrift.MessageType.CALL, this.seqid());
  var args = new ResourcesService_download_args();
  args.id = id;
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
...
ResourcesServiceClient.prototype.recv_download = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new ResourcesService_download_result();
  result.read(input);
  input.readMessageEnd();
...
ResourcesServiceProcessor.prototype.process_download = function(seqid, input, output) {
  var args = new ResourcesService_download_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.download.length === 1) {
    Q.fcall(this._handler.download, args.id)
      .then(function(result) {
        var result_obj = new ResourcesService_download_result({success: result});
        ...
        var result;
        if (err instanceof PublicStruct_ttypes.InvalidOperation) {
          result = new ResourcesService_download_result(err);
          output.writeMessageBegin("download", Thrift.MessageType.REPLY, seqid);
        } else {
          result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.download(args.id, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof PublicStruct_ttypes.InvalidOperation) {
        result_obj = new ResourcesService_download_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("download", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("download", Thrift.MessageType.EXCEPTION, seqid);
